...
public class UpdateStudentServlet extends HttpServlet {
 ...
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Admin is authenticated, display admin module content        
            ...
            String matrixNum = request.getParameter("studentMatrixNum");
            String course = request.getParameter("studentCourse");
            String mentor = request.getParameter("studentMentor");
            ...
            boolean updated = DatabaseDAO.updateStudentById(studentId, studentName, matrixNum, course, mentor, address, age, phoneNum, faculty);

            if (updated) {
                // Display a pop-up alert
                out.println("<script>");
                out.println("alert('Student updated successfully with ID: " + studentId + "');");
