...
public class AddStudentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // Admin is authenticated, display admin module content        
            ...
            String matrixNum = request.getParameter("matrixNum");
            ...
            int studentId = DatabaseDAO.insertStudent(name, matrixNum, course, mentor, address, age, phoneNum, faculty);

            if (studentId != -1) {
                // Display a pop-up alert
                out.println("<script>");
                out.println("alert('Student added successfully with ID: " + studentId + "');");
                out.println("window.location.replace('StudentServlet');");
                out.println("</script>");
            } else {
                out.println("Failed to add the student.");
            }
